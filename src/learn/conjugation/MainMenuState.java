	...
	public void execute(BufferedReader in, BufferedWriter out) throws IOException {
		...
		if (input.equals("q")) {
			...
			if (!fail)
				switch (zahl) {
				case 1: {
					ConjugationTrainer.changeState(ConjugationTrainer.createBoxState);
					break;
				}
				case 2: {
					ConjugationTrainer.changeState(ConjugationTrainer.loadBoxState);
					break;
				}
				case 3: {
					ConjugationTrainer.changeState(ConjugationTrainer.searchWordState);
					break;
				}
				case 4: {
